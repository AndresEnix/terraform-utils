...
enum Destroy implements Command {
    command('terraform destroy', true, false, '', ' ', false, true, new TerraformVersion(MIN_VERSION_SUPPORTED), new TerraformVersion(MAX_VERSION_SUPPORTED)),
    ...
    Destroy(label, mandatory, editable, value, separator, repeatable, empty, from, to) {
        this.label = label
