...
enum Untaint implements Command {
    command('terraform untaint', false, false, '', ' ', true, false, new TerraformVersion(MIN_VERSION_SUPPORTED), new TerraformVersion(MAX_VERSION_SUPPORTED)),
    ...
    Untaint(label, mandatory, editable, value, separator, repeatable, empty, from, to) {
        this.label = label
