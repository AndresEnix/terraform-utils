...
enum Import implements Command {
    command('terraform import', false, false, '', ' ', true, false, new TerraformVersion(MIN_VERSION_SUPPORTED), new TerraformVersion(MAX_VERSION_SUPPORTED)),
    ...
    config('-config', false, true, null, '=', false, false, new TerraformVersion(MIN_VERSION_SUPPORTED), new TerraformVersion(MAX_VERSION_SUPPORTED)),
    allow_missing_config('-allow-missing-config', false, false, null, null, false, true, new TerraformVersion(MIN_VERSION_SUPPORTED), new TerraformVersion(MAX_VERSION_SUPPORTED)),
    ...
    provider('-provider', false, true, null, '=', false, false, new TerraformVersion(MIN_VERSION_SUPPORTED), new TerraformVersion(MAX_VERSION_SUPPORTED)),
    ...
    Import(label, mandatory, editable, value, separator, repeatable, empty, from, to) {
        this.label = label
