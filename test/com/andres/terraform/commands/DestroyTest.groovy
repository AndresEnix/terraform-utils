...
class DestroyTest {
    ...
    void destroyCommand_withDefaultOptions() throws Exception {
        ...
        when:
        def actualCommand = getScript(Destroy.command, null)
    ...
    void destroyCommand_withUnsupportedOption() throws Exception {
        ...
        when:
        def actualCommand = getScript(Destroy.command, ['-xxfg': 'true'])
    ...
    void destroyCommand_withSupportedOption() throws Exception {
        ...
        when:
        def actualCommand = getScript(Destroy.command, ['-state': 'my-stafe.ftstate'])
    ...
    void destroyCommand_withMultipleUnsupportedOption() throws Exception {
        ...
        when:
        def actualCommand = getScript(Destroy.command, ['-abc': 'true', '-def': 'true', '-ghi': 'true'])
    ...
    void destroyCommand_withMultipleSupportedOption() throws Exception {
        ...
        when:
        def actualCommand = getScript(Destroy.command, ['-lock-timeout': '5s', '-lock': 'false', '-no-color': null])
    ...
    void destrroyCommand_withStringArguments() throws Exception {
        ...
        when:
        def actualCommand = getScript(Destroy.command, ['arguments': 'my_path'])
    ...
    void destroyCommand_varSeparatorIsWhitespace() throws Exception {
        ...
        when:
        def actualCommand = getScript(Destroy.command, ['-var': "'my_var=test'"])
    ...
    void destroyCommand_argumentDoNotContainsOptions() throws Exception {
        ...
        when:
        def actualCommand = getScript(Destroy.command, ['arguments': '-state=false my_path'])
    ...
    void destroyCommand_argumentsDoNotContainsOptions() throws Exception {
        ...
        when:
        def actualCommand = getScript(Destroy.command, ['arguments': ['-state="my_var=test"', "my_path"]])
